  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 pointer-events-none z-50 overflow-hidden", children: pieces.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        borderLeft: p.shape === "triangle" ? `${p.size / 2}px solid transparent` : void 0,
        borderRight: p.shape === "triangle" ? `${p.size / 2}px solid transparent` : void 0,
        borderBottom: p.shape === "triangle" ? `${p.size}px solid ${p.color}` : void 0,
...
function AnnouncementStrip() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-marquee whitespace-nowrap inline-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: "font-bangers text-xl tracking-widest text-white animate-blink",
          style: { textShadow: "2px 2px 0 #0a0a0a" },
          children: "🎉 SAMIR IS OFFICIALLY ANCIENT 🎉   |   HAPPY BIRTHDAY LEGEND 🔥   |   🎂 ANOTHER YEAR OF CHAOS BEGINS 🎂   |   🎊 PARTY TIME FOREVER 🎊   |   🎉 SAMIR IS OFFICIALLY ANCIENT 🎉   |   HAPPY BIRTHDAY LEGEND 🔥   |   🎂 THE LEGEND LIVES ON 🎂   |"
        }
      ) })
    }
  );
...
function ElectionHeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(160deg, #7b1c00 0%, #0a0a2b 50%, #003300 100%)",
        borderBottom: "6px solid #ff6b00"
      },
      "data-ocid": "election_hero.section",
      children: [
        bgEmojis.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Future Minister of Fun & Chill Affairs 😂"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "🇮🇳 Sabka Sath, Samir ka Vikas 🍕 🇮🇳"
                }
              )
            }
          ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    ...
                    style: {
                      ...
                      boxShadow: "0 0 0 4px #003300, 8px 8px 0 #0a0a0a, 0 0 40px rgba(255,107,0,0.6)",
                      borderRadius: "4px"
                    },
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-marquee whitespace-nowrap inline-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "📢 SAMIR! SAMIR! SAMIR! 📢  |  🗳️ VOTE KARO SAMIR KO! 🗳️  |  🎂 BIRTHDAY CANDIDATE 2025 🎂  |  📢 SAMIR! SAMIR! SAMIR! 📢  |  🎈 SAMIR ZINDABAD! 🎈  |  🔥 THE LEGEND THE CANDIDATE THE BIRTHDAY BOY 🔥  | "
              }
            ) })
          }
        )
...
function SamirHeroSection() {
  const [confettiActive, setConfettiActive] = reactExports.useState(true);
  const [showPranked, setShowPranked] = reactExports.useState(false);
  const [localConfetti, setLocalConfetti] = reactExports.useState([]);
  const audioContextRef = reactExports.useRef(null);
  const [musicStarted, setMusicStarted] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const timer = setTimeout(() => setConfettiActive(false), 9e3);
  ...
  function playBackgroundMusic() {
    try {
      let playNote = function(freq, startTime, duration, vol = 0.08) {
  ...
  function playPartyHorn() {
    try {
      ...
      gain.connect(ctx.destination);
      osc.type = "sawtooth";
      osc.frequency.setValueAtTime(400, now2);
      osc.frequency.exponentialRampToValueAtTime(1200, now2 + 0.3);
      ...
      osc2.type = "sawtooth";
      osc2.frequency.setValueAtTime(600, now2 + 0.45);
      osc2.frequency.exponentialRampToValueAtTime(1500, now2 + 0.75);
      gain2.gain.setValueAtTime(0.12, now2 + 0.45);
      gain2.gain.linearRampToValueAtTime(0, now2 + 0.8);
      osc2.start(now2 + 0.45);
      osc2.stop(now2 + 0.8);
    } catch {
    }
  }
  function handleSurpriseClick() {
    ...
    ue("😂 YOU JUST GOT PRANKED!! 😂", {
      description: "Classic Samir move -- can't resist a button 💀",
      duration: 5e3
    });
    setTimeout(() => setLocalConfetti([]), 7e3);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "radial-gradient(ellipse at center, #1a0040 0%, #0d0d2b 50%, #0a0a1a 100%)"
      },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Certified Party Legend Since Birth 💀"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-center", children: [
          [
            { id: "e0", emoji: "😂", angle: 0 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 0 40px #ff2bbf, 0 0 80px #ff2bbf, 0 0 120px #6a32ff, 8px 8px 0 #0a0a0a",
                overflow: "hidden",
                maxWidth: "340px",
                width: "80vw"
              },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    ...
                    style: {
                      width: "100%",
                      display: "block",
                      filter: "drop-shadow(0 0 15px #ff2bbf) brightness(1.05) contrast(1.05)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      border: "none",
                      letterSpacing: "0.04em",
                      cursor: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 32 32'><text y='28' font-size='28'>🍌</text></svg>") 16 16, pointer`
                    },
                    children: "CLICK FOR SURPRISE 😈"
                  }
                )
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "👇 SCROLL FOR CHAOS 👇"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiRain, { active: confettiActive }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 pointer-events-none z-50 overflow-hidden", children: localConfetti.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "confetti-piece",
            style: {
        ...
        showPranked && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm opacity-70", children: "You literally cannot follow basic instructions 💀" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "THINGS ONLY SAMIR DOES 😂🔥"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: roastItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              background: i % 3 === 0 ? "#ffe600" : i % 3 === 1 ? "#ff2bbf" : "#19d6ff",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "SAMIR'S LEGENDARY ACHIEVEMENTS 🏆"
          }
        ),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "WHY SAMIR IS A CERTIFIED LEGEND 🐐"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: legendReasons.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `legend.item.${i + 1}`,
            className: "rounded-2xl p-5 flex items-center gap-4 animate-card-float",
            style: {
              background: i === legendReasons.length - 1 ? "linear-gradient(135deg, #ff2bbf20, #6a32ff20)" : "rgba(26,22,90,0.8)",
              animationDelay: `${i * 0.25}s`,
              border: i === legendReasons.length - 1 ? "3px solid #ff2bbf" : "3px solid #19d6ff",
              boxShadow: i === legendReasons.length - 1 ? "0 0 20px #ff2bbf, 4px 4px 0 #0a0a0a" : "0 0 15px #19d6ff, 4px 4px 0 #0a0a0a"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: {
                    ...
                    textShadow: i === legendReasons.length - 1 ? "0 0 10px #ff2bbf" : "0 0 8px #19d6ff"
                  },
                  children: item.text
                }
              )
...
function SurpriseSection() {
  const [pranked, setPranked] = reactExports.useState(false);
  const [showModal, setShowModal] = reactExports.useState(false);
  const [localConfetti, setLocalConfetti] = reactExports.useState([]);
  const handleSurpriseClick = reactExports.useCallback(() => {
    setPranked(true);
    setShowModal(true);
    ...
    setTimeout(() => setLocalConfetti([]), 6e3);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "⚠️ DO NOT TOUCH THIS BUTTON ⚠️"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-nunito font-black mb-8", style: { color: "#ff2bbf" }, children: "I mean it. Seriously. Don't." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          pranked && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      ...
                      children: [
                        "Happy Birthday tho!! 🎉🎉🎉",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm opacity-70", children: "Samir could NEVER resist a forbidden button 💀" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Fireworks({ fireworks }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: fireworks.map((fw) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
...
function FinalSection() {
  const [balloons] = reactExports.useState(generateFloatingEmojis);
  const [fireworks, setFireworks] = reactExports.useState([]);
  const sectionRef = reactExports.useRef(null);
  const [visible, setVisible] = reactExports.useState(false);
  const ref = reactExports.useRef(null);
  const [shaking, setShaking] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #1a0a2e 0%, #0a1a2e 40%, #1a165a 100%)"
      },
      "data-ocid": "final.section",
      children: [
        balloons.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Fireworks, { fireworks }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ref,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Stay weird, stay awesome 🔥"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "From everyone who loves your chaotic energy ❤️🔥"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 mt-8", children: ["🎈", "🎉", "🎊", "🥳", "🎂", "🔥", "💜", "🐐"].map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-nunito font-bold text-sm", style: { color: "#ff2bbf" }, children: [
        "© ",
        year,
        ". Built with ❤️ using",
        " ",
...
function BirthdayPopups() {
  ...
  const shownRef = reactExports.useRef(/* @__PURE__ */ new Set());
  reactExports.useEffect(() => {
    const t1 = setTimeout(() => {
  ...
  const dismissPopup1 = reactExports.useCallback(() => {
    setPopup(null);
    setTimeout(() => {
  ...
  const dismissPopup2 = reactExports.useCallback(() => {
    setPopup(null);
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        popup === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  ...
                  children: "WARNING: SAMIR IS NOW OLD ⚠️"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-nunito font-black mb-5", style: { color: "white" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "OK I accept this tragedy"
                }
              )
            ]
          }
        ),
        popup === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "comic-card animate-pop-in max-w-sm w-full mx-4 p-8 text-center",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  ...
                  children: "REMINDER: SAMIR STILL CAN'T COOK 🎂"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
...
function AnimatedBackground() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(270deg, #1a165a, #0d0d2b, #1a0a2e, #0a1a2e)",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen", style: { background: "#0d0d2b" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed pointer-events-none z-40", children: chaosEmojis.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnnouncementStrip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ElectionHeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SamirHeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RoastSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AchievementsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LegendSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SurpriseSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FinalSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BirthdayPopups, {}),
